...
const winOptions = {
  win: {
    ...
    executableName: 'LXFlowMusic',
    legalTrademarks: 'LX Flow Music',
    signAndEditExecutable: process.env.LX_SKIP_EXE_EDIT == '1' ? false : undefined,
...
const linuxOptions = {
  linux: {
    ...
    desktop: {
      ...
      entry: {
        Name: 'LX Flow Music',
        'Name[zh_CN]': 'LX Flow Music',
        'Name[zh_TW]': 'LX Flow Music',
        Encoding: 'UTF-8',
        MimeType: 'x-scheme-handler/lxflowmusic',
        StartupNotify: 'false',
      },
    },
  },
