const modules = {
  ...
  winMain: {
    ...
    qq_music_set_cookie: 'qq_music_set_cookie',
    qq_music_status: 'qq_music_status',
    qq_music_login: 'qq_music_login',
    qq_music_daily_recommend: 'qq_music_daily_recommend',
    qq_music_radar_list: 'qq_music_radar_list',
    qq_music_radar_tracks: 'qq_music_radar_tracks',
    qq_music_recommend_playlists: 'qq_music_recommend_playlists',
    qq_music_account_playlists: 'qq_music_account_playlists',
    qq_music_account_playlist_detail: 'qq_music_account_playlist_detail',
    ...
    netease_music_account_playlists: 'netease_music_account_playlists',
    netease_music_account_playlist_detail: 'netease_music_account_playlist_detail',
