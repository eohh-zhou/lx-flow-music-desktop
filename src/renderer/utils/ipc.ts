...
export const setQQMusicCookie = async(cookie: string) => {
  await rendererInvoke<string, boolean>(WIN_MAIN_RENDERER_EVENT_NAME.qq_music_set_cookie, cookie)
}

export const getQQMusicStatus = async() => {
  return rendererInvoke<LX.QQMusic.Status>(WIN_MAIN_RENDERER_EVENT_NAME.qq_music_status)
}

export const loginQQMusic = async() => {
  return rendererInvoke<LX.QQMusic.LoginResult>(WIN_MAIN_RENDERER_EVENT_NAME.qq_music_login)
}

export const getQQMusicDailyRecommend = async() => {
  return rendererInvoke<LX.QQMusic.DailyRecommend>(WIN_MAIN_RENDERER_EVENT_NAME.qq_music_daily_recommend)
}

export const getQQMusicRadarList = async() => {
  return rendererInvoke<LX.QQMusic.RadarRecommend>(WIN_MAIN_RENDERER_EVENT_NAME.qq_music_radar_list)
}

export const getQQMusicRadarTracks = async(radioId: number) => {
  return rendererInvoke<number, LX.QQMusic.DailyRecommend>(WIN_MAIN_RENDERER_EVENT_NAME.qq_music_radar_tracks, radioId)
}

export const getQQMusicRecommendPlaylists = async() => {
...
export const reportQQMusicPlay = async(report: LX.QQMusic.PlayReport) => {
